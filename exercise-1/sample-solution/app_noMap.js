    ...
    <View style={ styles.app }>
      ...
      <View style={ styles.field }>
        <View style={ styles.row }>
          ...
          <Card onPress={ () => onPress(0, 1) } text={ cards[0][1] } />
          <Card onPress={ () => onPress(0, 2) } text={ cards[0][2] } />
        </View>
        <View style={ styles.row }>
          <Card onPress={ () => onPress(1, 0) } text={ cards[1][0] } />
          <Card onPress={ () => onPress(1, 1) } text={ cards[1][1] } />
          <Card onPress={ () => onPress(1, 2) } text={ cards[1][2] } />
        </View>
        <View style={ styles.row }>
          <Card onPress={ () => onPress(2, 0) } text={ cards[2][0] } />
          <Card onPress={ () => onPress(2, 1) } text={ cards[2][1] } />
          <Card onPress={ () => onPress(2, 2) } text={ cards[2][2] } />
        </View>
      </View>
    </View>
  )
